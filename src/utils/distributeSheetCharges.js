...
export default function distributeSheetCharges(width, height, totalCharges) {
    ...
    return relaxChargesOnPlane(positions, width, height);
}

function relaxChargesOnPlane(initialPositions, width, height, iterations = 1000, step = 0.01, damping = 0.95) {
